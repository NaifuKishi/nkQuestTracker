...
function internal.ConfigTabSettings (parent)
	...
	function tabPane:build ()
		...
		showHeaderCheckbox:SetFont(addonInfo.id, "Montserrat")
		...
		autoHideCheckbox:SetFont(addonInfo.id, "Montserrat")
		...
		alphaSlider:SetFont(addonInfo.id, "Montserrat")
		...
		bodyColor:SetFont(addonInfo.id, "Montserrat")
		...
		bodyCompleteColor:SetFont(addonInfo.id, "Montserrat")
		...
		categoryHeaderSize:SetFont(addonInfo.id, "Montserrat")
		...
		sortBySelect:SetFont(addonInfo.id, "Montserrat")
		...
		useAreaQuestUICheckbox:SetFont(addonInfo.id, "Montserrat")
		...
		usePluginCheckbox:SetFont(addonInfo.id, "Montserrat")
		...
		colorByLevelCheckbox:SetFont(addonInfo.id, "Montserrat")
		...
		showLevelCheckbox:SetFont(addonInfo.id, "Montserrat")
		...
		showZoneCheckbox:SetFont(addonInfo.id, "Montserrat")
		...
		labelCategories:SetTextFont(addonInfo.id, "MontserratSemiBold")
		...
		EnKai.ui.setFont(headerShowCategory, addonInfo.id, "Montserrat")
		...
		EnKai.ui.setFont(headerCategoryColor, addonInfo.id, "Montserrat")
		...
		EnKai.ui.setFont(headerCategoryTitleSize, addonInfo.id, "Montserrat")
		...
		headerCategoryBodySize:SetTextFont(addonInfo.id, "Montserrat")
		...
		for k, v in pairs(nkQuestTrackerSetup.categoryOrder) do
			...
			showCategoryCheckbox:SetFont(addonInfo.id, "Montserrat")
			...
			categorySize:SetFont(addonInfo.id, "Montserrat")
			...
			categoryBodySize:SetFont(addonInfo.id, "Montserrat")
